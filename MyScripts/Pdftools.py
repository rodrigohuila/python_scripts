...
def get_contacts(filename): 
    ...
    print()
    print("Escoja los Items que desea enviar:")
    desde = int(input("Digite Renglón de la casilla de excel desde: "))
    ...
    while True:
        ...
        try: 
            ...
            if option == 1: # DIPLOMAS
                ...
                clear()
                PASSWORD = input('Digite la clave de aplicaciones para Gmail: ')#'xqwdzjbamvfiztnt'
                ...
                for name, email in zip(names, emails): # FOR EACH CONTACT, SEND THE EMAIL:
                    msg = MIMEMultipart()       # create a message                            
                    message = message_template.substitute(PERSON_NAME=name.title()) # add in the actual person name to the message template
